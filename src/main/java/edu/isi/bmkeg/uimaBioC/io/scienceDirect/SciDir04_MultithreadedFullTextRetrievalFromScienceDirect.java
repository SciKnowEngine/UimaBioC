 ...
 * 
 */
public class SciDir04_MultithreadedFullTextRetrievalFromScienceDirect {
	...
	private static Logger logger = Logger
			.getLogger(SciDir04_MultithreadedFullTextRetrievalFromScienceDirect.class);
	...
	public static void main(String[] args) throws Exception {
		...
		SciDir04_MultithreadedFullTextRetrievalFromScienceDirect readScienceDirect = new SciDir04_MultithreadedFullTextRetrievalFromScienceDirect();
